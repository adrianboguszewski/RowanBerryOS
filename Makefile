...
C_SOURCES = $(wildcard $(SRC)/kernel/*.c $(SRC)/drivers/*.c $(SRC)/debug/*.c $(SRC)/boot/idt/*.c)
HEADERS = $(wildcard $(SRC)/kernel/*.h $(SRC)/drivers/*.h $(SRC)/debug/*.h $(SRC)/boot/idt/*.h $(SRC)/const/*.h)
